...
# First pair of plots:
name1 = 'MC_uniform_lowT1.txt'
name2 = 'MC_uniform_highT1.txt'

# Second pair of plots:
name3 = 'MC_uniform_lowT2.txt'
name4 = 'MC_uniform_highT2.txt'
...
tsteps1, walkers1, l01, dt1, N_final1, calctime1, positions1, varlist1 = read_data_MC(name3)
tsteps2, walkers2, l02, dt2, N_final2, calctime2, positions2, varlist2 = read_data_MC(name4)
...
bins = [i*l01+l01/2.0 for i in range(m)]
...
plt.grid('on')
plt.savefig('MC_uniform_twoplot_T2.eps', format='eps', dpi=1000)
plt.show()